...
const Auth = ({ navigation }) => {
  const [request, response, promptAsync] = Google.useIdTokenAuthRequest({
    ...
    clientId: '391495645952-7mb5miv1echiutbv35um4158acmbdm64.apps.googleusercontent.com',
  });
  ...
  return (
    <View style={styles.container}>
      <TouchableHighlight style={styles.button} onPress={promptAsync} underlayColor="clear">
